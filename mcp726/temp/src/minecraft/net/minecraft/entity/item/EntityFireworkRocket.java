...
public class EntityFireworkRocket extends Entity {
   ...
   public EntityFireworkRocket(World p_i8009_1_, double p_i8009_2_, double p_i8009_4_, double p_i8009_6_, ItemStack p_i8009_8_) {
      ...
      this.field_92010_b = 10 * var9 + this.field_70146_Z.nextInt(6) + this.field_70146_Z.nextInt(7);
   }
   ...
   public void func_70071_h_() {
      ...
      ++this.field_92011_a;
      if(this.field_70170_p.field_72995_K && this.field_92011_a % 2 < 2) {
      ...
      if(!this.field_70170_p.field_72995_K && this.field_92011_a > this.field_92010_b) {
   ...
   public void func_70014_b(NBTTagCompound p_70014_1_) {
      p_70014_1_.func_74768_a("Life", this.field_92011_a);
      p_70014_1_.func_74768_a("LifeTime", this.field_92010_b);
      ItemStack var2 = this.field_70180_af.func_82710_f(8);
      if(var2 != null) {
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      this.field_92011_a = p_70037_1_.func_74762_e("Life");
      this.field_92010_b = p_70037_1_.func_74762_e("LifeTime");

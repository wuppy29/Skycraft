...
public class EntityItem extends Entity {
   ...
   public boolean func_70097_a(DamageSource p_70097_1_, int p_70097_2_) {
      if(this.func_85032_ar()) {
         return false;
      } else if(this.func_92014_d() != null && this.func_92014_d().field_77993_c == Item.field_82792_bS.field_77779_bT && p_70097_1_ == DamageSource.field_76378_k) {
         return false;
      } else {
         this.func_70018_K();
   ...
   public void func_70014_b(NBTTagCompound p_70014_1_) {
      ...
      if(this.func_92014_d() != null) {
         p_70014_1_.func_74766_a("Item", this.func_92014_d().func_77955_b(new NBTTagCompound()));
      }
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      this.func_92013_a(ItemStack.func_77949_a(var2));
      if(this.func_92014_d() == null) {
         this.func_70106_y();
      }
   ...
   public String func_70023_ak() {
      return StatCollector.func_74838_a("item." + this.func_92014_d().func_77977_a());
   }
   ...
   public void func_92013_a(ItemStack p_92013_1_) {
      this.func_70096_w().func_75692_b(10, p_92013_1_);

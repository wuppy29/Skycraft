...
public class RecipesIngots {
   ...
   public void func_77590_a(CraftingManager p_77590_1_) {
      for(int var2 = 0; var2 < this.field_77591_a.length; ++var2) {
         ...
         p_77590_1_.func_92051_a(new ItemStack(var3), new Object[]{"###", "###", "###", Character.valueOf('#'), var4});
         p_77590_1_.func_92051_a(var4, new Object[]{"#", Character.valueOf('#'), var3});
      }

      p_77590_1_.func_92051_a(new ItemStack(Item.field_77717_p), new Object[]{"###", "###", "###", Character.valueOf('#'), Item.field_77733_bq});
      p_77590_1_.func_92051_a(new ItemStack(Item.field_77733_bq, 9), new Object[]{"#", Character.valueOf('#'), Item.field_77717_p});
   }
}

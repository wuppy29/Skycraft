...
public class TileEntityMobSpawner extends TileEntity {
   ...
   public String func_92015_a() {
      return this.field_70391_e == null?this.field_70390_d:this.field_70391_e.field_92033_c;
   }
      ...
      if(this.func_70386_b()) {
         ...
         if(this.field_70331_k.field_72995_K) {
            ...
            for(int var2 = 0; var2 < this.field_70395_h; ++var2) {
               Entity var13 = EntityList.func_75620_a(this.func_92015_a(), this.field_70331_k);
               if(var13 == null) {
                  return;
               }
   ...
   public void func_70383_a(Entity p_70383_1_) {
      if(this.field_70391_e != null) {
         ...
         Iterator var3 = this.field_70391_e.field_92032_b.func_74758_c().iterator();
   ...
   private void func_70387_f() {
      ...
      if(this.field_92016_e != null && this.field_92016_e.size() > 0) {
         this.field_70391_e = (TileEntityMobSpawnerSpawnData)WeightedRandom.func_76271_a(this.field_70331_k.field_73012_v, this.field_92016_e);
   ...
   public void func_70307_a(NBTTagCompound p_70307_1_) {
      ...
      if(p_70307_1_.func_74764_b("SpawnPotentials")) {
         ...
         for(int var3 = 0; var3 < var2.func_74745_c(); ++var3) {
            this.field_92016_e.add(new TileEntityMobSpawnerSpawnData(this, (NBTTagCompound)var2.func_74743_b(var3)));
         }
      } else {
   ...
   public void func_70310_b(NBTTagCompound p_70310_1_) {
      ...
      p_70310_1_.func_74778_a("EntityId", this.func_92015_a());
      ...
      if(this.field_70391_e != null) {
         p_70310_1_.func_74766_a("SpawnData", (NBTTagCompound)this.field_70391_e.field_92032_b.func_74737_b());
      }

      if(this.field_70391_e != null || this.field_92016_e != null && this.field_92016_e.size() > 0) {
         ...
         if(this.field_92016_e != null && this.field_92016_e.size() > 0) {
            ...
            while(var3.hasNext()) {
               ...
               var2.func_74742_a(var4.func_92030_a());
            }
         } else {
            var2.func_74742_a(this.field_70391_e.func_92030_a());
         }
   ...
   public Entity func_70382_c() {
      if(this.field_92017_j == null) {
         Entity var1 = EntityList.func_75620_a(this.func_92015_a(), (World)null);

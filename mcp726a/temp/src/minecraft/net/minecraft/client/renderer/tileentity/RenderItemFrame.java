...
public class RenderItemFrame extends Render {
   ...
   private void func_82402_b(EntityItemFrame p_82402_1_) {
      ...
      if(var2 != null) {
         ...
         var3.func_92014_d().field_77994_a = 1;
         ...
         if(var3.func_92014_d().func_77973_b() == Item.field_77744_bd) {
            ...
            var4.func_78381_a();
            MapData var6 = Item.field_77744_bd.func_77873_a(var3.func_92014_d(), p_82402_1_.field_70170_p);
            if(var6 != null) {
               this.field_76990_c.field_78721_f.field_78449_f.func_78319_a((EntityPlayer)null, this.field_76990_c.field_78724_e, var6);
            }
         } else {
            if(var3.func_92014_d().func_77973_b() == Item.field_77750_aQ) {

...
public class EnchantmentProtection extends Enchantment {
   ...
   public static int func_92041_a(Entity p_92041_0_, int p_92041_1_) {
      int var2 = EnchantmentHelper.func_77511_a(Enchantment.field_77329_d.field_77352_x, p_92041_0_.func_70035_c());
      if(var2 > 0) {
         p_92041_1_ -= MathHelper.func_76141_d((float)p_92041_1_ * (float)var2 * 0.15F);
      }

      return p_92041_1_;
   }

   public static double func_92040_a(Entity p_92040_0_, double p_92040_1_) {
      int var3 = EnchantmentHelper.func_77511_a(Enchantment.field_77327_f.field_77352_x, p_92040_0_.func_70035_c());
      if(var3 > 0) {
         p_92040_1_ -= (double)MathHelper.func_76128_c(p_92040_1_ * (double)((float)var3 * 0.15F));
      }

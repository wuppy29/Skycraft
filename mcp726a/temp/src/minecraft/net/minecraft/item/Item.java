...
public class Item {
   ...
   public static Item field_92052_bU = (new ItemFirework(145)).func_77652_b(9, 12).func_77655_b("fireworks");
   public static Item field_92054_bV = (new ItemFireworkCharge(146)).func_77652_b(10, 12).func_77655_b("fireworksCharge").func_77637_a(CreativeTabs.field_78026_f);
   public static ItemEnchantedBook field_92053_bW = (ItemEnchantedBook)(new ItemEnchantedBook(147)).func_77652_b(15, 12).func_77625_d(1).func_77655_b("enchantedBook");

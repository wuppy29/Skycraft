...
public class Packet23VehicleSpawn extends Packet {
   ...
   public Packet23VehicleSpawn(Entity p_i3290_1_, int p_i3290_2_, int p_i3290_3_) {
      ...
      this.field_92025_h = MathHelper.func_76141_d(p_i3290_1_.field_70125_A * 256.0F / 360.0F);
      this.field_92026_i = MathHelper.func_76141_d(p_i3290_1_.field_70177_z * 256.0F / 360.0F);
   ...
   public void func_73267_a(DataInputStream p_73267_1_) throws IOException {
      ...
      this.field_92025_h = p_73267_1_.readByte();
      this.field_92026_i = p_73267_1_.readByte();
   ...
   public void func_73273_a(DataOutputStream p_73273_1_) throws IOException {
      ...
      p_73273_1_.writeByte(this.field_92025_h);
      p_73273_1_.writeByte(this.field_92026_i);

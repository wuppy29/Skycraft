...
class TileEntityMobSpawnerSpawnData extends WeightedRandomItem {
   ...
   public TileEntityMobSpawnerSpawnData(TileEntityMobSpawner p_i8017_1_, NBTTagCompound p_i8017_2_) {
      ...
      this.field_92031_d = p_i8017_1_;
      this.field_92032_b = p_i8017_2_.func_74775_l("Properties");
      this.field_92033_c = p_i8017_2_.func_74779_i("Type");
   }

   public TileEntityMobSpawnerSpawnData(TileEntityMobSpawner p_i8018_1_, NBTTagCompound p_i8018_2_, String p_i8018_3_) {
      super(1);
      this.field_92031_d = p_i8018_1_;
      this.field_92032_b = p_i8018_2_;
      this.field_92033_c = p_i8018_3_;
   }

   public NBTTagCompound func_92030_a() {
      NBTTagCompound var1 = new NBTTagCompound();
      var1.func_74766_a("Properties", this.field_92032_b);
      var1.func_74778_a("Type", this.field_92033_c);

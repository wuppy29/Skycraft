      ...
      if(this.func_74860_a(p_74875_1_, p_74875_3_)) {
         ...
         for(var9 = 0; var9 < this.field_74955_d; ++var9) {
            ...
            if(p_74875_2_.nextInt(100) == 0) {
               this.func_74879_a(p_74875_1_, p_74875_3_, p_74875_2_, 2, 0, var10 - 1, WeightedRandomChestContent.func_92029_a(StructureMineshaftPieces.func_78816_a(), new WeightedRandomChestContent[]{Item.field_92053_bW.func_92059_b(p_74875_2_)}), 3 + p_74875_2_.nextInt(4));
            }

            if(p_74875_2_.nextInt(100) == 0) {
               this.func_74879_a(p_74875_1_, p_74875_3_, p_74875_2_, 0, 0, var10 + 1, WeightedRandomChestContent.func_92029_a(StructureMineshaftPieces.func_78816_a(), new WeightedRandomChestContent[]{Item.field_92053_bW.func_92059_b(p_74875_2_)}), 3 + p_74875_2_.nextInt(4));
            }
